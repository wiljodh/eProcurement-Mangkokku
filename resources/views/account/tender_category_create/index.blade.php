...
<div class="ibox ">
        <div class="ibox-title">
            <h5 class="text-success">Create Tender Category</h5>
        ...
        <div class="ibox-content row">
            ...
            <form action="/tender-actions/category/create" class="col-10" method="POST" enctype="multipart/form-data" >
                ...
                <div class="form-group row "><label class="col-2 col-form-label">Icon :</label>
                    <div class="col-4">
                            <input type="text" id="icon_txt"  class="form-control" name="icon" value="{{old('icon')}}">
                 ...
                 <div class="form-group row ">
                    <div class="col-3 col-offset-3 pt-4">
                        <button class="btn-block btn btn-sm btn-success float-left ml" type="submit">Save</button>
                    </div>
             </div>
             </div>
            </form>
